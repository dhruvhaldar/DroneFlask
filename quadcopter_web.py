...
from quadcopter_bdsim import power_system, rigid_body_dynamics, MIXER_F, MIXER_PHI, MIXER_THETA, MIXER_PSI
import time
...
def flight_controller_interactive(cmd, state):
    ...
    # Optimization: Use pre-computed constants and multiplication
