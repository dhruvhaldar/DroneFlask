...
function refresh() {
  ...
  $("map-coords").textContent = world?.location.classic ? `X ${state.x.toFixed(0)} m / Z ${state.z.toFixed(0)} m` : coordinates ? `${coordinates[1].toFixed(5)}, ${coordinates[0].toFixed(5)}` : "Loading…";
